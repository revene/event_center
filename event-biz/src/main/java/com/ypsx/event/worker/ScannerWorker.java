...
public class ScannerWorker implements Runnable {
        ...
        try {
            ...
            while (dataSize == DEFAULT_SCAN_SIZE) {
                ...
                Result<List<Event>> scanResult = eventScanManager.scanList(
                        buildEventQuery(EventStatus.ACTIVE.getStatus(), startTime, endTime, offet, DEFAULT_SCAN_SIZE), hintTableIndex);
     ...
     * @return
     */
    private EventQuery buildEventQuery(int eventStatus, long startTime, long endTime, long offset, int pageSize) {
